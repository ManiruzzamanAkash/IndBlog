...
if ( ! function_exists( 'indblog_scripts' ) ) {
    ...
    */
    function indblog_scripts() {
        ...
        // Enqueue styles.
        wp_enqueue_style( 'indblog-slick-css', $dir_uri . "/assets/vendors/slick/slick.css", array(), GENERATE_VERSION );
        wp_enqueue_style( 'indblog-slick-theme-css', $dir_uri . "/assets/vendors/slick/slick-theme.css", array(), GENERATE_VERSION );
        ...
        // Enqueue Scripts.
        wp_enqueue_script( 'indblog-slick', $dir_uri . "/assets/vendors/slick/slick.min.js", array( 'jquery' ), '1.8.1' );
